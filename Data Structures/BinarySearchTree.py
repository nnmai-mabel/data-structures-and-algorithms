...
class BinaryTree:
    ...
    # Delete node
    # def delete_recursively(self, root, value):
    #     if root is None:
    #         return root
        
    #     if value < root.data:
    #         root.left = self.delete_recursively(root.left, value)
    #     elif value > root.data:
    #         root.right = self.delete_recursively(root.right, value)
    #     else: # the root is the current node to be deleted
    ...
    #         # Node has 2 children or leaf node
    #         # Find smallest node of the right subtree and replace with the root's data
    #         min_value = root.data
    #         while root.right.left is not None:
    #             min_value = root.right.left.data
    #             root = root.right.left

    #         # Replace the current root data with the smallest value of right subtree
    #         root.data = min_value
    #         root.right = self.delete_recursively(root.right, root.data)
